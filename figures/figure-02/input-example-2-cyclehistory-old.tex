\begin{tikzpicture}[%
  ...
  \node[lnode,below=1.0cm of A1,xshift=+2.5cm] (A4) {State 3\hphantom{0}\\Mets.\\1,4};
  \node[lnode,below=1.22cm of A2] (A23) {State 4\hphantom{0}\\Mets.\\1,2,3};
  \node[lnode,below=1.22cm of A23,fill=none,draw=white,text=white] (A234) {State 6\hphantom{0}\\Mets.\\1,2,3,4};
  \node[lnode,below=1.22cm of A4] (A43) {State 5\hphantom{0}\\Mets.\\1,4,3};
  \node[lnode,below=1.22cm of A43,fill=none,draw=white,text=white] (A432) {State 7\hphantom{0}\\Mets.\\1,4,3,2};
  ...
  \draw[cartoon,tbTeal, bend left=22,postaction={decorate}] (A43) to node [above left=0.1pt,xshift=-3.0pt,yshift=-3.0pt] {1/3} (A1);
  ...
  % Blanks for spacing
  \node[lnode,fill=white,below=1.22cm of A23,text=white,draw=white,fill opacity=1.0] (A234) {State 6\hphantom{0}\\Mets.\\1,2,3,4};
  \node[lnode,fill=white,below=1.22cm of A43,text=white,draw=white,fill opacity=1.0] (A432) {State 7\hphantom{0}\\Mets.\\1,4,3,2};
  \node[lnode,below=1.22cm of A23] (A234) {State 6\hphantom{0}\\Mets.\\1,2,3,4};
  \node[lnode,below=1.22cm of A43] (A432) {State 7\hphantom{0}\\Mets.\\1,4,3,2};
