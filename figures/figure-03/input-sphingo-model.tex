\begin{tikzpicture}[%
  %>=latex,
  ctlinedd/.style={% cartoon line (dotted)
    dotted,
    line width=0.75pt
  },
  cartoon/.style={% cartoon arrow (solid)
    {Square[slant=-0.5,length=\the\pgflinewidth]}-{Stealth},
    line width=0.75pt
  },
  ctline/.style={% cartoon line (solid)
    {Square[slant=-0.5,length=\the\pgflinewidth]}-{Square[slant=-0.5,length=\the\pgflinewidth]},
    line width=0.75pt
  },
  ctlined/.style={% cartoon line (dashed)
    {Square[slant=-0.5,length=\the\pgflinewidth]}-{Square[slant=-0.5,length=\the\pgflinewidth]},
    dashed,
    line width=0.75pt
  },
  cartoonMA/.style={% cartoon arrow (solid; mass action reactions)
    {Square[slant=-0.5,length=\the\pgflinewidth]}-{Stealth},
    %draw=mPurple,
    line width=0.75pt
  },
  ctlineMA/.style={% cartoon line (solid; mass action reactions)
    {Square[slant=-0.5,length=\the\pgflinewidth]}-{Square[slant=-0.5,length=\the\pgflinewidth]},
    %draw=mPurple,
    line width=0.75pt
  },
  ctlinedMA/.style={% cartoon line (dashed; mass action reactions)
    {Square[slant=-0.5,length=\the\pgflinewidth]}-{Square[slant=-0.5,length=\the\pgflinewidth]},
    %draw=mPurple,
    dashed,
    line width=0.75pt
  },
  cartoonOM/.style={% cartoon arrow (solid; outer membrane compartment)
    {Square[slant=-0.5,length=\the\pgflinewidth]}-{Stealth},
    %draw=mGreen,
    line width=0.75pt
  },
  ctlineOM/.style={% cartoon line (outer membrane compartment)
    {Square[slant=-0.5,length=\the\pgflinewidth]}-{Square[slant=-0.5,length=\the\pgflinewidth]},
    %draw=mGreen,
    line width=0.75pt
  },
  ctlinedOM/.style={% cartoon line (dashed; outer membrane compartment)
    {Square[slant=-0.5,length=\the\pgflinewidth]}-{Square[slant=-0.5,length=\the\pgflinewidth]},
    %draw=mGreen,
    dashed,
    line width=0.75pt
  },
  cartoonIM/.style={% cartoon arrow (solid; inner membrane compartment)
    {Square[slant=-0.5,length=\the\pgflinewidth]}-{Stealth},
    %draw=mOlive,
    line width=0.75pt
  },
  ctlineIM/.style={% cartoon line (solid; inner membrane compartment)
    {Square[slant=-0.5,length=\the\pgflinewidth]}-{Square[slant=-0.5,length=\the\pgflinewidth]},
    %draw=mOlive,
    line width=0.75pt
  },
  ctlinedIM/.style={% cartoon line (dashed; inner membrane compartment)
    {Square[slant=-0.5,length=\the\pgflinewidth]}-{Square[slant=-0.5,length=\the\pgflinewidth]},
    %draw=mOlive,
    dashed,
    line width=0.75pt
  },
  cartoonNu/.style={% cartoon arrow (solid; nucleus compartment)
    {Square[slant=-0.5,length=\the\pgflinewidth]}-{Stealth},
    %draw=mWine,
    line width=0.75pt
  },
  ctlineNu/.style={% cartoon line (solid; nucleus compartment)
    {Square[slant=-0.5,length=\the\pgflinewidth]}-{Square[slant=-0.5,length=\the\pgflinewidth]},
    %draw=mWine,
    line width=0.75pt
  },
  ctlinedNu/.style={% cartoon line (dashed; nucleus compartment)
    {Square[slant=-0.5,length=\the\pgflinewidth]}-{Square[slant=-0.5,length=\the\pgflinewidth]},
    %draw=mWine,
    dashed,
    line width=0.75pt
  },
  cartoonER/.style={% cartoon arrow (solid; endoplasmic reticulum compartment)
    {Square[slant=-0.5,length=\the\pgflinewidth]}-{Stealth},
    %draw=mRose,
    line width=0.75pt
  },
  ctlineER/.style={% cartoon line (solid; endoplasmic reticulum compartment)
    {Square[slant=-0.5,length=\the\pgflinewidth]}-{Square[slant=-0.5,length=\the\pgflinewidth]},
    %draw=mRose,
    line width=0.75pt
  },
  ctlinedER/.style={% cartoon line (dashed; endoplasmic reticulum compartment)
    {Square[slant=-0.5,length=\the\pgflinewidth]}-{Square[slant=-0.5,length=\the\pgflinewidth]},
    %draw=mRose,
    dashed,
    line width=0.75pt
  },
  cartoonMi/.style={% cartoon arrow (solid; mitochondria compartment)
    {Square[slant=-0.5,length=\the\pgflinewidth]}-{Stealth},
    %draw=mIndigo,
    line width=0.75pt
  },
  ctlineMi/.style={% cartoon line (solid; mitochondria compartment)
    {Square[slant=-0.5,length=\the\pgflinewidth]}-{Square[slant=-0.5,length=\the\pgflinewidth]},
    %draw=mIndigo,
    line width=0.75pt
  },
  ctlinedMi/.style={% cartoon line (dashed; mitochondria compartment)
    {Square[slant=-0.5,length=\the\pgflinewidth]}-{Square[slant=-0.5,length=\the\pgflinewidth]},
    %draw=mIndigo,
    dashed,
    line width=0.75pt
  },
  cartoonLy/.style={% cartoon arrow (solid; lysosome compartment)
    {Square[slant=-0.5,length=\the\pgflinewidth]}-{Stealth},
    %draw=mCyan,
    line width=0.75pt
  },
  ctlineLy/.style={% cartoon line (solid; lysosome compartment)
    {Square[slant=-0.5,length=\the\pgflinewidth]}-{Square[slant=-0.5,length=\the\pgflinewidth]},
    %draw=mCyan,
    line width=0.75pt
  },
  ctlinedLy/.style={% cartoon line (dashed; lysosome compartment)
    {Square[slant=-0.5,length=\the\pgflinewidth]}-{Square[slant=-0.5,length=\the\pgflinewidth]},
    %draw=mCyan,
    dashed,
    line width=0.75pt
  },
  cartoonGA/.style={% cartoon arrow (solid; golgi apparatus compartment)
    {Square[slant=-0.5,length=\the\pgflinewidth]}-{Stealth},
    %draw=mTeal,
    line width=0.75pt
  },
  ctlineGA/.style={% cartoon line (solid; golgi apparatus compartment)
    {Square[slant=-0.5,length=\the\pgflinewidth]}-{Square[slant=-0.5,length=\the\pgflinewidth]},
    %draw=mTeal,
    line width=0.75pt
  },
  ctlinedGA/.style={% cartoon line (dashed; golgi apparatus compartment)
    {Square[slant=-0.5,length=\the\pgflinewidth]}-{Square[slant=-0.5,length=\the\pgflinewidth]},
    %draw=mTeal,
    dashed,
    line width=0.75pt
  },
  cartoonCF/.style={% cartoon arrow (solid; golgi apparatus cytoplasmic face compartment)
    {Square[slant=-0.5,length=\the\pgflinewidth]}-{Stealth},
    %draw=mSand,
    line width=0.75pt
  },
  ctlineCF/.style={% cartoon line (solid; golgi apparatus cytoplasmic face compartment)
    {Square[slant=-0.5,length=\the\pgflinewidth]}-{Square[slant=-0.5,length=\the\pgflinewidth]},
    %draw=mSand,
    line width=0.75pt
  },
  ctlinedCF/.style={% cartoon line (dashed; golgi apparatus cytoplasmic face compartment)
    {Square[slant=-0.5,length=\the\pgflinewidth]}-{Square[slant=-0.5,length=\the\pgflinewidth]},
    %draw=mSand,
    dashed,
    line width=0.75pt
  },
  every node/.style={% default/backup properties of all nodes
    font=\sffamily\footnotesize\itshape,
    text=black,
    text centered,
    align=center
  },
  frame/.style={% default/backup bounding box frame properties for compartments
    draw,
    draw=black,
    thick,
    inner sep=5pt,
  ...
  every label/.style={% default/backup label properties
    text=black,
  ...
  % OM nodes (metabolites and some rxn nodes)
  \node[met] (OM_S1P) {S1P};
  \node[rx2,left=1.5cm of OM_S1P, label=below:R68] (rxn_68) {};
  \node[met,below=1.0cm of OM_S1P] (OM_SPH) {SPH};
  \node[rx1,label=below left:R27] at ($(OM_S1P)!0.5!(OM_SPH)$) (rxn_27) {};
  \node[rx2,left=1.5cm of OM_SPH, label=below:R67] (rxn_67) {};
  \node[enz,anchor=west] at ($(rxn_67)!0.5!(rxn_68)$) (OM_SK12) {SK 1-2};
  \node[met,below=1.0cm of OM_SPH] (OM_CER) {CER};
  \node[rx2,left=1.5cm of OM_CER, label=below:R66] (rxn_66) {};
  \node[met,below=2.5cm of OM_CER] (OM_SM) {SM};
  \node[rx2,left=1.5cm of OM_SM, label=below:R64] (rxn_64) {};
  \node[enz,anchor=west] at ($(rxn_67)!0.5!(rxn_66)$) (OM_NCDASE) {NCDase};
  \node[rx1,xshift=0.75cm,label=above right:R69] at ($(OM_S1P)!0.5!(OM_SPH)$) (rxn_69) {};
  \node[enz,right=0.75cm of rxn_69] (OM_PAP) {PAP2a-b-c};
  \node[enz,anchor=west] at ($(rxn_64)!0.25!(rxn_66)$) (OM_aSMase) {aSMase};
  \node[rx2,below=1.75cm of OM_SM, label=below:R56] (rxn_56) {};
  \node[met,above=2.5cm of OM_PAP] (OM_GSL) {OM\_GSL};
  \node[rx2,above=0.15cm of OM_GSL, label=above:R46] (rxn_46) {};
  \node[rx2,label=below:R65] at ($(rxn_64)!0.5!(rxn_66)$) (rxn_65) {};
  ...
  \node[rx1,above=0.2cm of OM_C1P,label=right:R63] (rxn_63) {};
  \node[rx2,above=1.5cm of OM_S1P,xshift=-1.5cm,label=above:R48] (rxn_48) {};
  ...
  \node[rx1,label=left:R30] at ($(IM_S1P)!0.5!(IM_SPH)$) (rxn_30) {};
  \node[enz,xshift=1.25cm] at ($(IM_S1P)!0.5!(IM_SPH)$) (IM_SK1) {SK1};
  \node[rx1,label=left:R29] at ($(IM_CER)!0.5!(IM_SPH)$) (rxn_29) {};
  \node[enz,xshift=1.25cm] at ($(IM_CER)!0.5!(IM_SPH)$) (IM_NCDase) {NCDase};
  \node[rx1,above=0.396cm of IM_SM,label=left:R28] (rxn_28) {};
  \node[enz,anchor=center] at (rxn_28 -| IM_NCDase) (IM_nSMase2) {nSMase2};
  \node[rx2,below=0.50cm of IM_SM,label=left:R23] (rxn_23) {};
  ...
  \node[right=1.75cm of ER_CER,draw=white] (ER_PH2) {};
  \node[rx1,label=above:R06] at ($(ER_PH)!0.5!(ER_S1P)$) (rxn_06) {};
  \node[enz,below=1.0cm of rxn_06] (ER_SPL1) {SPL1};
  \node[rx1,label=below:R05,yshift=+0.5cm] at ($(ER_S1P)!0.5!(ER_SPH)$) (rxn_05) {};
  \node[rx1,label=above:R04,yshift=-0.5cm] at ($(ER_S1P)!0.5!(ER_SPH)$) (rxn_04) {};
  \node[rx1,label=below:R03,yshift=+0.5cm] at ($(ER_CER)!0.5!(ER_SPH)$) (rxn_03) {};
  \node[rx1,label=above:R02,yshift=-0.5cm] at ($(ER_CER)!0.5!(ER_SPH)$) (rxn_02) {};
  \node[rx1,label=right:R01,yshift=+0.5cm] at ($(ER_CER)!0.5!(ER_PH2)$) (rxn_01) {};
  ...
  \node[rx1,label=above right:R12,yshift=+0.5cm] at ($(N_S1P)!0.5!(N_SPH)$) (rxn_12) {};
  \node[rx1,label={below right,yshift=-0.1cm}:R11,yshift=-0.0cm] at ($(N_S1P)!0.5!(N_SPH)$) (rxn_11) {};
  \node[rx1,label=above:R10,yshift=-0.0cm] at ($(N_SPH)!0.5!(N_CER)$) (rxn_10) {};
  \node[rx1,label={below right,yshift=-0.1cm}:R09,yshift=-0.0cm] at ($(N_CER)!0.5!(N_SM)$) (rxn_09) {};
  \node[rx1,label=above right:R08,yshift=+0.5cm] at ($(N_CER)!0.5!(N_SM)$) (rxn_08) {};
  ...
  \node[rx2,below=1.2cm of N_S1P,label=right:R15] (rxn_15) {};
  \node[rx2,label=right:R14] at (rxn_15 -| N_SPH) (rxn_14) {};
  \node[rx2,label=right:R13] at (rxn_15 -| N_SM) (rxn_13) {};

  % L nodes (metabolites and some rxn nodes)
  \node[met,right=18.5cm of rxn_46] (L_GSL) {GSL};
  \node[met] at (L_GSL |- rxn_48) (L_SM) {SM};
  \node[rx1,right=0.75cm of L_SM,label=above:R49] (rxn_49) {};
  \node[met,right=0.75cm of rxn_49] (L_CER) {CER};
  \node[rx1,right=0.75cm of L_CER,label=above:R50] (rxn_50) {};
  \node[met,right=0.75cm of rxn_50] (L_SPH) {SPH};
  \node[rx1,label={above,yshift=-0.05cm}:R47] at (L_GSL -| L_CER) (rxn_47) {};
  ...
  \node[rx2,below=1.5cm of L_SPH,label=right:R51] (rxn_51) {};

  % GA nodes (metabolites and some rxn nodes)
  \node[met] at (OM_C1P -| rxn_49) (GA_C1P) {C1P};
  \node[met] at (rxn_56 -| GA_C1P) (GA_CER) {CER};
  \node[met,left=1.5cm of GA_CER] (GA_SM) {SM};
  \node[rx1,label=above right:R57,yshift=+0.0cm] at ($(GA_SM)!0.5!(GA_CER)$) (rxn_57) {};
  \node[rx1,label=below right:R55,yshift=-0.5cm] at ($(GA_SM)!0.5!(GA_CER)$) (rxn_55) {};
  ...
  \node[rx1,label=below:R58,yshift=+0.0cm] at ($(GA_CER)!0.535!(GA_SPH)$) (rxn_58) {};
  \node[rx1,label=above right:R53,yshift=+0.0cm] at ($(GA_S1P)!0.5!(GA_SPH)$) (rxn_53) {};
  \node[enz,above=0.5cm of rxn_53] (GA_SK1) {SK1};
  \node[enz] at (GA_SMS1 -| rxn_53) (GA_PAP) {PAP2a-b};
  \node[rx1,label=below right:R54] at (rxn_55 -| rxn_53) (rxn_54) {};
  \node[rx1,label=above left:R59] at ($(GA_C1P)!0.35!(GA_CER)$) (rxn_59) {};
  \node[rx1,label={below right,yshift=-0.1cm}:R60,right=0.3cm of rxn_59] (rxn_60) {};
  ...
  \node[rx1,above=2.0cm of GACF_CER,label=left:R41] (rxn_41) {};
  ...
  \node[rx2,label=below:R42] at ($(GA_GluCER)!0.4!(GACF_GluCER)$) (rxn_42) {};
  \node[enz,above=0.5cm of rxn_42] (GA_FAPP2) {FAPP2};
  \node[rx1,label=below:R43] at ($(GA_GluCER)!0.5!(GA_LacCER)$) (rxn_43) {};
  \node[enz,above=0.5cm of rxn_43] (GA_LacCerS) {LacCerS};
  \node[rx1,label=below:R44] at ($(GA_GSL)!0.38!(GA_LacCER)$) (rxn_44) {};
  ...
  \node[rx1,label=above right:R19,yshift=+0.15cm] at ($(M_CER)!0.5!(M_SPH)$) (rxn_19) {};
  \node[rx1,label=below right:R20,yshift=-0.15cm] at ($(M_CER)!0.5!(M_SPH)$) (rxn_20) {};
  \node[rx1,label=above right:R17,yshift=+0.15cm] at ($(M_SPH)!0.5!(M_S1P)$) (rxn_17) {};
  \node[rx1,label=below right:R18,yshift=-0.15cm] at ($(M_SPH)!0.5!(M_S1P)$) (rxn_18) {};
  ...
  % C nodes (metabolites and some rxn nodes)
  \node[rx2,label=below:R39] at (ER_CER -| GA_CER) (rxn_39) {};
  \node[enz,right=0.5cm of rxn_39] (C_CERT) {CERT};
  \node[rx2,below=3.0cm of GACF_CER,label=below:R40] (rxn_40) {};
  \node[rx2,label=above:R45] at (OM_GSL -| GA_GSL) (rxn_45) {};
  \node[rx2,label=right:R38] at (rxn_01 -| M_CER) (rxn_38) {};
  \node[met,right=5.5cm of OM_PAP2,yshift=0.25cm] (C_S1P) {S1P};
  \node[met] at (C_S1P -| N_SK2) (C_SPH) {SPH};
  \node[rx1,label=below:R36] at ($(C_SPH)!0.5!(C_S1P)$) (rxn_36) {};
  \node[rx2,label=right:R52] at (C_SPH -| GA_SPH) (rxn_52) {};
  \node[enz,above=0.5cm of rxn_36] (C_SK2) {SK2};
  \node[rx2,above=7.20cm of ER_CER,label=left:R07] (rxn_07) {};
  \node[rx2,label=left:R24] at ($(OM_SM)!0.5!(ER_SM)$) (rxn_24) {};
  \node[rx2,label=above:R61] at (M_CER |- GA_C1P) (rxn_61) {};
  \node[rx2,label=above:R34] at (IM_S1P -| C_S1P) (rxn_34) {};
  \node[rx2,label=above:R35,above=0.75cm of C_SPH] (rxn_35) {};
  \node[rx2,label=left:R37,below=4.25cm of C_S1P] (rxn_37) {};
  \node[rx2,label=left:R22,below=4.25cm of C_SPH] (rxn_22) {};
  \node[rx2,label=right:R21,above=1.7cm of M_SPH] (rxn_21) {};
  \node[rx2,label=below:R16] at (ER_CerS |- M_S1P) (rxn_16) {};

  % OM edges (rxns and some metabolic rxn nodes)
  \draw[cartoonOM] (OM_C1P) to node [rx1,label=left:R62] (rxn_62) {} (OM_CER);
  \draw[cartoonOM] (OM_CER) to node [rx1,label=right:R26] (rxn_26) {} (OM_SPH);
  \draw[cartoonOM] (OM_SM) to node [rx1,yshift=-0.75cm,label=right:R25] (rxn_25) {} (OM_CER);
  ...
  \draw[cartoonMA] (IM_S1P) to node [rx2,xshift=0cm,label=above:R33] (rxn_33) {} (OM_S1P);
  \draw[cartoonMA] (OM_SPH) to node [rx2,xshift=0cm,label=above:R32] (rxn_32) {} (IM_SPH);
  \draw[cartoonMA] (OM_CER) to node [rx2,xshift=0cm,label=above:R31] (rxn_31) {} (IM_CER);
