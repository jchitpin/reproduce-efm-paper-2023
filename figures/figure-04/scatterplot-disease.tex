...
\begin{tikzpicture}
  \begin{groupplot}[
    ...
    \nextgroupplot[%
      ...
      \addplot[mystyle] table [x index=0, y index=1, meta index=2, col sep=tab, skip first n=0, discard if not={class}{Markov}] {../../data/scatterplot-total-efm-weights-ad-log.csv};
