...
\pgfplotstableread[col sep=tab]{/home/jchitpin/Documents/PhD/Projects/reproduce-efm-paper-2023/data/barplot-zero-weight-freq-ad.csv}\mydata
...
\begin{tikzpicture}
  \begin{groupplot}[
    ...
    \nextgroupplot[%
      ...
      \addplot[mystyle] table [x index=0, y index=1, meta index=2, col sep=tab, skip first n=0] {/home/jchitpin/Documents/PhD/Projects/reproduce-efm-paper-2023/data/scatterplot-total-efm-weights-ad-log.csv};
      %\legend{Markov, Min L2 (2), Max qSPA (2), Max lSPA (8), Min lSPA (8), Min milAP (1)};
      \addplot[mystyle] table [x index=0, y index=1, meta index=2, col sep=tab, skip first n=0, discard if not={class}{Markov}] {/home/jchitpin/Documents/PhD/Projects/reproduce-efm-paper-2023/data/scatterplot-total-efm-weights-ad-log.csv};
    ...
    \nextgroupplot[%
      ...
      \addplot [fill=tbTeal] table [y=S2, meta=Label, x expr=\coordindex]{\mydata};
      \addplot [fill=tbCyan] table [y=S3, meta=Label, x expr=\coordindex]{\mydata};
